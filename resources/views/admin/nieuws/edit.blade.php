                ...
                <form method="POST" action="{{ route('admin.nieuws.update', $nieuws) }}" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <x-text-input id="title" name="title" type="text" class="block mt-1 w-full"
                                      :value="$nieuws->title" required maxlength="255"/>
                    </div>

                    <div>
                        <x-input-label for="content" value="Inhoud"/>
                        <textarea id="content" name="content" rows="6" required
                                  class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">{{ $nieuws->content }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <x-text-input id="publication_date" name="publication_date" type="date"
                                      ...
                                      :value="$nieuws->publication_date->format('Y-m-d')" required/>
                    </div>
